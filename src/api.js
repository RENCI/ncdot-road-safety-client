...
export const api = {
  ...
  getFalsePositives: (annotation, route_id) => axios.get(`/get_model_fps/${ annotation }/${ route_id ? route_id : '' }`),
  getFalseNegatives: (annotation, route_id) => axios.get(`/get_model_fns/${ annotation }/${ route_id ? route_id : '' }`)
}
